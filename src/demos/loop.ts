...
import { Parameters, type ControlPanelElements } from '../control-panel/index.js';
import { SketchDraw, SketchInit, SketchLoop, SketchReset } from '../sketch/Sketch.js';
...
const loop: SketchLoop<CustomControls, SketchData> = ({ canvas, palette, params }, data, { frameTime }: FrameData) => {
