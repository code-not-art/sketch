...
export const FullPageSketch = <TParameters extends ControlPanelElements, DataModel extends object>({
	sketch,
}: {
	...
	return (
		<FullscreenWrapper>
			...
			<SketchController sketch={sketch} canvasId={canvasId} downloaderId={downloaderId} />
