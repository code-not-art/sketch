...
export default class ImageState {
	...
	constructor({ seed, paletteType = PaletteType.Random }: ImageStateParams = {}) {
		...
		this._imageSeedGenerator = new Random('image seed generator', this._rng.next().toString());
		this._colorSeedGenerator = new Random('color seed generator', this._rng.next().toString());
