...
export type PaletteType = typeof PaletteType extends infer T ? T[keyof T] : never;

export const createSketchConfig = ({
	width = 1080,
	height = 1080,
	seed,
	menuDelay,
...
export type SketchConfig = ReturnType<typeof createSketchConfig>;
