...
import { ArrowLeft, ArrowRight, Image, Pause, PenTool, Play, Save, Share2 } from 'react-feather';
...
const Controls = ({ state, loopState, params, draw, download, videoControls = false }: ControlsProps) => {
	/**
