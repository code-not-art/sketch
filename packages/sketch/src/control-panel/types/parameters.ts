...
export type ControlPanelParameterType = (typeof ControlPanelParameterTypes)[number];

export type ControlPanelParameterBase<TDataType extends ControlPanelParameterType, TValue> = {
	dataType: TDataType;
	label: string;
	initialValue?: TValue;
	hidden: boolean;
...
type ParameterTemplate<TDataType extends ControlPanelParameterType, TValue, TConfig> = Identity<
	ControlPanelParameterBase<TDataType, TValue> & TConfig
>;
